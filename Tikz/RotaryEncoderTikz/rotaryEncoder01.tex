...
%	rotaryEncoderLines{\angleAtwo}{#2}{#3}{#4-#5*2}{#4-#5};
	...
	%% Mark outer
	\pgfmathsetmacro{\markOuterPosY}{65mm};
	\draw[line width=0.1mm] (1cm,1cm+\markOuterPosY) -- (-1cm,1cm+\markOuterPosY);
	\draw[line width=0.1mm] (-1cm,1cm+\markOuterPosY) -- (-1cm,-1cm+\markOuterPosY);
	\draw[line width=0.1mm] (-1cm,-1cm+\markOuterPosY) -- (1cm,-1cm+\markOuterPosY);
	\draw[line width=0.1mm] (1cm,-1cm+\markOuterPosY) -- (1cm,1cm+\markOuterPosY);
	%% Mark mittle
	\draw[line width=0.1mm] (1cm,1cm) -- (-1cm,1cm);
	\draw[line width=0.1mm] (-1cm,1cm) -- (-1cm,-1cm);
	\draw[line width=0.1mm] (-1cm,-1cm) -- (1cm,-1cm);
	\draw[line width=0.1mm] (1cm,-1cm) -- (1cm,1cm);
	%% Cross
...
\begin{scope}[]
	\rotaryEncoder{0}{360}{0.5}{85mm}{5mm}
\end{scope}
\begin{scope}[shift={(0,-18cm)}]
	\rotaryEncoder{0}{360}{0.4}{85mm}{5mm}
\end{scope}
%\begin{scope}[]
