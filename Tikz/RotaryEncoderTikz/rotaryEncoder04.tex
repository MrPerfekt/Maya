...
\newcommand{\rotaryEncoder}[5]{%Angle1, Angle2, EncodeLineDegreeStep, OuterRadius, LineWidth
	\rotaryEncoderLines{#1}{#2}{#3}{#4-#5}{#4};
	\drawArc{#1+#3}{#1+2*#3}{#4-#5}{#4};
%	pgfmathsetmacro{\angleAtwo}{#1+#3/2};
%	rotaryEncoderLines{\angleAtwo}{#2}{#3}{#4-#5*2}{#4-#5};

  	\begin{scope}[shift={(0,30mm)}]
	\drawSimpleRect{10mm}{10mm}
	\end{scope}
...
%	%% Mark outer
%	\pgfmathsetmacro{\markOuterPosY}{30mm};
%	\draw[line width=0.1mm] (1cm,1cm+\markOuterPosY) -- (-1cm,1cm+\markOuterPosY);
%	\draw[line width=0.1mm] (-1cm,1cm+\markOuterPosY) -- (-1cm,-1cm+\markOuterPosY);
%	\draw[line width=0.1mm] (-1cm,-1cm+\markOuterPosY) -- (1cm,-1cm+\markOuterPosY);
%	\draw[line width=0.1mm] (1cm,-1cm+\markOuterPosY) -- (1cm,1cm+\markOuterPosY);
%	%% Mark mittle
%	\draw[line width=0.1mm] (5mm,5mm) -- (-5mm,5mm);
%	\draw[line width=0.1mm] (-5mm,5mm) -- (-5mm,-5mm);
%	\draw[line width=0.1mm] (-5mm,-5mm) -- (5mm,-5mm);
%	\draw[line width=0.1mm] (5mm,-5mm) -- (5mm,5mm);
%	%% Cross
%	\draw[line width=0.1mm] (0cm,-2cm) -- (0cm,2cm);
%	\draw[line width=0.1mm] (-2cm,0cm) -- (2cm,0cm);
...
%	\draw[line width=0.1mm] (#1:5mm) arc (#1:#2+#3:5mm);
	...
	\node[draw,rotate=-45] (t) at (45:30mm) {#3$^\circ$};
%%Draw width mask
...
\begin{scope}[]
	\rotaryEncoder{0}{360}{1}{59mm}{10mm}
\end{scope}
\begin{scope}[shift={(0,-13cm)}]
	\rotaryEncoder{0}{360}{0.7}{59mm}{10mm}
\end{scope}
%\begin{scope}[]
