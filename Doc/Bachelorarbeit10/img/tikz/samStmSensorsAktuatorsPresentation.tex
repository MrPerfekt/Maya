...
\draw[->,line width=2pt, color=green] ($ (sam.east) + (0,0.35) $) -- ($ (stm.west) + (0,0.35) $);
\draw[<->,line width=2pt] (sam) -- (stm);
\draw[<-,line width=2pt, color=red] ($ (sam.east) + (0,-0.35) $) -- ($ (stm.west) + (0,-0.35) $);
\draw[<-,line width=2pt, color=green] (sam) -- (li.east);
\draw[<-,line width=2pt, color=green] (sam) -- (ro.east);
\draw[<-,line width=2pt, color=green] (sam) -- (fo.east);
\draw[->,line width=2pt] (sam) -- (an.east);
\draw[->,line width=2pt, color=red] (sam) -- (sp.east);
