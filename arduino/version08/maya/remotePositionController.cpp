...
void remoteControllerLightBarrierStepperPinChanged() {
	RemotePositionController::getInstance()->lightBarrierStepperPinChanged();
}

void remoteControllerLightBarrierEncoderPinChanged() {
	RemotePositionController::getInstance()->lightBarrierEncoderPinChanged();
}
...
void remoteControllerStepperInputPinChanged() {
	RemotePositionController::getInstance()->stepperInputPinChanged();
}

void RemotePositionController::init() {
	attachInterrupt(lightBarrierPins[lightBarrierEncoderNr0], remoteControllerLightBarrierEncoderPinChanged, CHANGE);//Need to call discPositioner->update!
...
void RemotePositionController::stepperInputPinChanged() {

}

void RemotePositionController::lightBarrierStepperPinChanged() {
...
void RemotePositionController::lightBarrierEncoderPinChanged() {
